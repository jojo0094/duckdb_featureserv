	...
	for _, tt := range tests {
		t.Run(tt.name, func(t *testing.T) {
			...
			if tt.envTableIncludes != "" {
				os.Setenv("DUCKDBFS_DATABASE_TABLEINCLUDES", tt.envTableIncludes)
			}
			if tt.envTableExcludes != "" {
				os.Setenv("DUCKDBFS_DATABASE_TABLEEXCLUDES", tt.envTableExcludes)
			}
...
`
	...
	os.Setenv("DUCKDBFS_DATABASE_TABLEINCLUDES", "override_schema")
	os.Setenv("DUCKDBFS_DATABASE_TABLEEXCLUDES", "override_schema.excluded")
	...
	for _, scenario := range scenarios {
		t.Run(scenario.name, func(t *testing.T) {
			...
			if scenario.envIncludes != "" {
				os.Setenv("DUCKDBFS_DATABASE_TABLEINCLUDES", scenario.envIncludes)
			}
			if scenario.envExcludes != "" {
				os.Setenv("DUCKDBFS_DATABASE_TABLEEXCLUDES", scenario.envExcludes)
			}
